    ...
    <div id="main">
      <div id="page">
        ...
        <section
          class="hero-slider"
          style="
            background: url({{asset('public/assets/img/career/slider.jpg')}}) 50% 50% / cover
              no-repeat;
          "
        >
          <div class="container">
              ...
              <div class="welcome-onboard">
                <div class="col-lg-10 col-md-10 col-sm-12">
                  <div class="hero-slider__content">
                    ...
                    >
                      Join Our Forward-Thinking <span>Innovators</span>
                    </h2>
                    <p class="hero-slider__lead white-text lead-text">
                      We are an experienced, forward-thinking team of software
                      engineers shaping a new reality with exciting ideas and
                      cutting-edge technology. Join us and get new opportunities
                      for career growth.
                    </p>
                  </div>
                </div>
                ...
                <div id="map" class="map-scroll">
                  <section class="jobs">
                    <div class="container">
                      ...
                      <div id="jobsApp">
                        <div data-reactroot="" class="jobs__positions">
                          <ul class="position-list">
                            <li class="position">
                              <a href="{{url('apply-career')}}" target="blank">
                                <div class="position__title">
                                  Android Kotlin Developer
                                </div>
                                <div class="position__location"></div>
                              </a>
                            </li>
                            <li class="position">
                              <a href="{{url('apply-career')}}" target="blank">
                      ...
                      <div class="jobs__cv-block">
                        <h4 class="jobs__cv-header">
                          Haven’t found the position you’re interested in?
                        </h4>
                        <a
                          class="button button--send-cv"
                          href="{{url('apply-career')}}"
                          target="_blank"
                          >Send Us Your CV</a
                        >
                      </div>
